...
#define HID_JOYSTICK_INTERFACE		  0x01U

#define HID_MOUSE_REPORT_DESC_SIZE	  40U
#define HID_JOYSTICK_REPORT_DESC_SIZE 40U

#define HID_MOUSE_EPIN_ADDR			  0x81U
#define HID_JOYSTICK_EPIN_ADDR		  0x82U

#define HID_MOUSE_EPIN_SIZE			  0x05U
#define HID_JOYSTICK_EPIN_SIZE		  0x05U
////////////////////////////////////////////////
...
typedef struct
{
  ...
  HID_StateTypeDef     Joystickstate;
}
